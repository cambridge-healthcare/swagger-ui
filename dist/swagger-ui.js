...
function program1(depth0,data) {
  ...
  buffer += "<div class='container resources_container'>\n    <h4 class=\"baseurl\" style=\"color: #999\">[ <span style=\"font-variant: small-caps\">base url</span>: ";
...
(function() {
  ...
  MainView = (function(_super) {
    ...
    MainView.prototype.addResource = function(resource) {
      ...
      return $('#' + api_id + ' .resources').append(resourceView.render().el);
    };
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.submitOperation = function(e) {
      ...
      if (error_free) {
        ...
        has_body = function() {
          return _this.model.httpMethod === 'put' || _this.model.httpMethod === 'post';
        };
        invocationUrl = this.model.urlify(params_split.path) + (query_string && !has_body() ? '?' + query_string : '');
        ...
        obj = {
          ...
          data: has_body() ? bodyParam || query_string : void 0,
