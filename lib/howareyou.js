(function ($) {
  ...
  var AUTH_HOST = 'https://auth.howareyou.com';
  ...
  if (/^(((\d+\.){3}(\d+))|localhost)$/.test(location.hostname)) {
    ...
    howareyou.apis = [
      host + ":9292/chid_doc.json",
      host + ":9005/cds_doc.json",
      host + ":9494/snomed_doc.json"
    ];
    ...
    howareyou.apis = [
      API_HOST + "/chid_doc.json",
      API_HOST + "/cds_doc.json",
      API_HOST + "/snomed_doc.json"
    ];
  }
